...
(function() {
  ...
  var CanvasInput = window.CanvasInput = function(o) {
    ...
    self._offScreenCanvas = document.createElement('canvas');
    self._offScreenCanvas.setAttribute('width', self._width + self._padding * 2);
    self._offScreenCanvas.setAttribute('height', self._height + self._padding * 2);
    self._shadowCtx = self._offScreenCanvas.getContext('2d');
    ...
    render: function() {
      ...
      self._drawTextBox(function() {
        ...
        if (isBlur > 0) {
          ...
          ctx.drawImage(self._offScreenCanvas, 0, 0, scw, sch, bw + self.shadowL, bw + self.shadowT, scw, sch);
        }
